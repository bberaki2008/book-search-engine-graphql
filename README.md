...
# Book Search Engin GraphQL<a id="title"></a> [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) <a id="license-badge"></a>

## Description <a id="description"></a>

This is App is for readers who want to search for new books to read and keep a list of books to purchase.
...
HTML, CSS, JavaScript, nodejs Apollo and react
...
![Alt Site Screenshot of my portfolio](./public/img/Screenshot.png)
